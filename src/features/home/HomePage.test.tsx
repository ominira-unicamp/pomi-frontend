...
vi.mock('@/features/home/todayClasses', async (importOriginal) => {
...
vi.mock('@/features/home/dailyMenuApi', () => ({
  listDailyMenus,
}))

vi.mock('@/features/curriculum-planner/data/curriculumPersistenceApi', () => ({
  listCurricula,
  getCurriculum,
}))

vi.mock('@/features/semester-planner/data/semesterPlanningApi', () => ({
...
vi.mock('@/features/curriculum-planner/data/curriculumPlannerApi', () => ({
