...
import type { CurriculumDraftBootstrap, SemesterDraftBootstrap } from '@/planner/data/planningDraftBootstrap'
...
import {
  clearDraftHandoff,
  loadDraftHandoff,
} from '@/planner/data/planningDraftHandoff'
import {
  curriculumDraftBootstrapKey,
  semesterDraftBootstrapKey,
} from '@/planner/data/planningDraftBootstrap'
import { createSemesterPlanning } from '@/semester-planner/data/semesterPlanningApi'
