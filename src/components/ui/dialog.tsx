  ...
  return (
    <DialogPrimitive.Portal>
      ...
      <DialogPrimitive.Content
        className={cn(
          'fixed inset-x-0 bottom-0 z-50 max-h-[calc(100dvh-1rem)] w-full overflow-visible rounded-t-lg border-2 border-strong-border bg-card p-5 text-card-foreground shadow-[0_-5px_0_var(--strong-border)] sm:top-1/2 sm:right-auto sm:bottom-auto sm:left-1/2 sm:w-[calc(100%-2rem)] sm:max-w-md sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-lg sm:p-6 sm:shadow-[7px_7px_0_var(--strong-border)]',
          className,
        )}
        {...props}
      >
